...
class Student(Base):
    ...
    # Step 98: added via migration 'add is_active to students'
...
# Step 102: new table added via migration 'add course_schedule table'
...
if __name__ == "__main__":
    ...
    # (In practice, once Alembic is set up in Hands-On 7, Alembic manages
    # table creation/evolution instead of calling create_all() directly.)
